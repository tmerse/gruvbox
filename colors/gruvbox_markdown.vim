...
let s:gb.bright_red     = ['#928374', 167]     " 251-73-52    TAGS
let s:gb.bright_green   = ['#928374', 142]     " 184-187-38   HEADLINE
let s:gb.bright_yellow  = ['#fabd2f', 214]     " 250-189-47
let s:gb.bright_blue    = ['#665c54', 109]     " 131-165-152  LINKS
let s:gb.bright_purple  = ['#d3869b', 175]     " 211-134-155
let s:gb.bright_aqua    = ['#7c6f64', 108]     " 142-192-124  CODE
